...
(function(){
	...
	Chart.Scale = Chart.Element.extend({
		...
		fit: function(){
			...
			/*
			 *	This sets what is returned from calculateScaleRange as static2 properties of this class:
			 *
				this.steps;
				this.stepValue;
				this.min;
...
(function(){
	...
	Chart.Type.extend({
		...
		initialize:  function(data){
			...
			//Declare segments as a static2 property to prevent inheriting across the Chart type prototype
			this.segments = [];
