...
(/** @lends <global> */function( $ ) {
	...
	/**
	 * Take the column definitions and static2 columns arrays and calculate how
	...
	{
		// On first run a static2 variable is set, since this is only needed once.
	...
	{
		// Only extend API instances and static2 properties of the API
	...
	DataTable.defaults = {
		 ...
		 * during initialisation in addition to through the static2
	...
	DataTable.ext = _ext = {
		 ...
		 * than just the static2 string that DataTables knows of.
		 * 
